...
export default function Barra({ isDark, setIsDark }) {
  ...
  return (
    ...
    /* Anchos fijos en lg para evitar saltos, crecimiento solo en xl */
    w-[140px] lg:w-[130px] xl:w-[200px] xl:focus-within:w-[240px] 
    ${isDark ? "border-white/30 focus-within:border-white shadow-[0_1px_0_0_rgba(255,255,255,0.1)]" : "border-black/30 focus-within:border-black shadow-[0_1px_0_0_rgba(0,0,0,0.05)]"}`}
            >
              ...
              <input
                ...
                /* Fuente más pequeña en lg para que el placeholder no apriete */
            ...
            {showSuggestions && sugerencias.length > 0 && (
              <ul
                className={`absolute top-[110%] left-0 w-64 mt-2 border-2 shadow-[0_25px_60px_rgba(0,0,0,0.4)] z-[120] backdrop-blur-md ${isDark ? "bg-black/95 border-white" : "bg-white/95 border-black"}`}
              >
                {sugerencias.map((s, i) => (
                  <li
                    key={i}
