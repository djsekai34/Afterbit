...
export default function ProtocoloUI({ isDark, currentTextColor }) {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        {pantallas.map((p, index) => {
          // Variable para identificar visualmente los pares (02, 04, etc)
          ...
          return (
            <Motion.section
              key={p.id}
              variants={itemVariants}
              className={`flex flex-col-reverse ${isEven ? "lg:flex-row-reverse" : "lg:flex-row"} gap-16 lg:gap-24 mb-80 relative items-start`}
            >
  ...
  `}
              ...
              <div
                className={`w-full lg:w-[45%] flex flex-col space-y-12 pt-4 ${isEven ? "lg:items-end lg:text-right" : "lg:items-start lg:text-left"}`}
              >
                <div>
                  <h2
                    className={`
                  ...
                  <div
                    className={`w-20 h-2 bg-green-500 mb-6 ${isEven ? "lg:ml-auto" : ""}`}
                  />
                  <p
                ...
                <div
                  className={`border-green-600 py-4 bg-green-500/5 ${isEven ? "border-r-4 pr-8" : "border-l-4 pl-8"}`}
                >
                ...
                <div>
                  ...
                  <div
                    className={`flex flex-wrap gap-2.5 ${isEven ? "justify-end" : "justify-center"}`}
                  >
                ...
                >
                  <div
                    className={`flex items-start gap-5 ${isEven ? "flex-row-reverse" : ""}`}
                  >
