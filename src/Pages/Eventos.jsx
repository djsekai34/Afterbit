                    ...
                    {isEventFuture(selectedEvent) && (
                      <div className="mt-8 pt-6 border-t border-zinc-500/20 space-y-3">
                        ...
                        <div className="grid grid-cols-1 gap-2">
                          <a href={generateGoogleCalendarLink(selectedEvent)} target="_blank" rel="noopener noreferrer" className={`flex items-center justify-center py-2 px-4 border font-black transition-all hover:scale-[1.02] active:scale-95 ${isDark ? "bg-white text-black border-white" : "bg-black text-white border-black"}`}>GOOGLE CALENDAR</a>
