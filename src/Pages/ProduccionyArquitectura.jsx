...
export default function Documentacion({ isDark }) {
  ...
  const diaryEntries = [
    {
      f: "Noviembre",
      t: "Creación del equipo y la idea del videojuego",
      d: "Creamos el equipo definitivo para el diseño del videojuego, como también plasmamos la idea que teníamos para el juego hasta llegar a la idea final.",
    },
    {
      f: "Diciembre",
      t: "Creación de Rodolfo, los enemigos y el logo del videojuego",
      d: "Creamos a Rodolfo en sus diferentes sprites necesarios para el videojuego, también creamos a los enemigos del Santo Reino, como el logo del videojuego.",
    },
    {
      f: "Enero",
      t: "Creación del videojuego",
      d: "Creamos el videojuego con sus pantallas correspondientes, sus mecánicas y los dos primeros niveles.",
    },
    {
      f: "Feb, Mar y Abr (1ª)",
      t: "Terminar el videojuego",
      d: "Creamos el resto de los niveles que nos faltaban.",
    },
    {
      f: "Abr (2ª) y May (1ª)",
      t: "Testear el videojuego y mejoras",
      d: "Testeamos el videojuego, lo pulimos y añadimos mejoras tras el feedback dado.",
    },
    {
      f: "May (2ª) y Junio",
      t: "Pulir, testear y lanzar el juego",
      d: "Pulimos lo que nos comentaron, lo volvemos a testear y lanzamos el juego oficialmente.",
    },
  ];
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <h1 className="text-4xl md:text-7xl font-black italic uppercase tracking-tighter">
            Producción y{" "}
            <span style={{ color: accentGreen }}>Arquitectura</span>
          </h1>
        </Motion.header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <section>
              ...
              >
                <p className="text-md opacity-80 leading-relaxed italic">
                  Afterbit ha decidido una organización de carpetas clara y
                  sencilla para que cada miembro del equipo localice los
                  recursos instantáneamente. El equipo se dividió en dos áreas
                  core: <strong>Programación</strong> y{" "}
                  <strong>Arte + Música</strong>.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  {
                    n: "David Jiménez",
                    r: "Lead Tech Developer & World Builder",
                    t: "Arquitectura en C#, lógica de sistemas, desarrollo integral del Santo Reino y creacion de Rodolfo.",
                  },
                  {
                    n: "PunketoMlg",
                    r: "2D Visual & Audio Designer",
                    t: "Dirección artística del Reino, assets visuales y composición de BSO.",
                  },
                ].map((role, i) => (
                  <Motion.div
                    key={i}
                    variants={itemVariants}
                    className="p-4 border relative group overflow-hidden"
                    style={{ borderColor: subtleBorder }}
                  >
                    <div className="absolute -right-2 -bottom-2 font-mono text-4xl opacity-[0.03] font-black italic select-none">
                      {role.n.split(" ")[0]}
                    </div>
                    <div className="flex justify-between items-start mb-1">
                      <span className="block text-[10px] font-mono opacity-50 uppercase tracking-tighter">
                        Role_0{i + 1}
                      </span>
                      <span
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={tool}
                      className="px-3 py-1 border text-[10px] font-mono uppercase font-bold hover:bg-white/5 transition-colors cursor-default"
                      style={{ borderColor: currentTextColor }}
                    >
                      {tool}
                    </span>
          ...
          <div className="lg:col-span-7">
            ...
            >
              <h2
                className="text-2xl font-black uppercase mb-8 flex justify-between items-end border-b-2 pb-4"
                style={{ borderColor: subtleBorder }}
              >
              ...
              <div className="mt-8 space-y-4">
                ...
                <p className="text-sm opacity-80 leading-snug">
                  Hemos implementado una arquitectura sencilla, teniendo en
                  cuenta que es nuestro primer proyecto. Hemos decidido ir por
                  algo sencillo que cualquier parte del equipo de Afterbit lo
                  entienda y la nueva gente que se una al proyecto.
                </p>
              </div>
            </Motion.section>
          </div>
        ...
        <section className="mt-40">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-8 gap-8">
            ...
            <div className="flex w-full lg:w-auto gap-3">
              <button
                onClick={prevPage}
                className="flex-1 lg:flex-none whitespace-nowrap px-6 py-3 border text-[10px] md:text-xs font-mono font-bold hover:bg-white/10 transition-all flex items-center justify-center gap-2"
                style={{ borderColor: subtleBorder }}
              >
              ...
              >
                {diaryEntries
                  ...
                  .map((entry, idx) => (
                    <div
                      key={idx}
                      className="p-8 border-l-4 relative group overflow-hidden"
                      style={{
                        borderColor: accentGreen,
                        backgroundColor: `${currentTextColor}05`,
                      }}
                    >
                      <div className="absolute top-4 right-6 font-mono text-[60px] opacity-[0.03] font-black italic select-none">
                        {(idx + 1 + currentPage * entriesPerPage)
                          .toString()
                          .padStart(2, "0")}
                      </div>
                      ...
                      <h4
                        className="font-extrabold uppercase italic mb-4 text-xl leading-tight border-b pb-2"
                        style={{ borderColor: `${currentTextColor}11` }}
                      >
                        {entry.t}
                      </h4>
              ...
              {[...Array(totalPages)].map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor:
                      i === currentPage ? accentGreen : `${currentTextColor}22`,
                  }}
                />
              ))}
            </div>
        ...
        >
          <div className="w-full relative overflow-visible">
            ...
            <p className="text-lg md:text-2xl font-light leading-relaxed italic opacity-90 max-w-5xl mb-16">
              "Este es nuestro primer proyecto. Como{" "}
              <strong className="font-extrabold" style={{ color: accentGreen }}>
                David Jiménez
              </strong>
              , fundador de Afterbit y estudiante del curso de especialización
              en Videojuegos y VR, debo decir que este camino ha sido hermoso.
              Ha tenido sus complicaciones, como es normal al tratarse de mi
              primer videojuego, pero estoy feliz con el resultado. Quién me iba
              a decir a mí, a ese niño de 6 años, que algún día crearía un
              videojuego. Me alegra tener bien planteado en nuestra web oficial
              todo lo relacionado con nuestra primera IP, y que el juego salga
              de manera adecuada y totalmente profesional."
            </p>
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-16 relative">
              <div className="flex items-center gap-6">
                ...
                >
                  {MiFoto ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center font-mono text-[10px] text-white p-2">
                      FOTO
                    </div>
                  )}
                </div>
                ...
                <div className="flex flex-col relative z-10">
                  <span className="block font-black uppercase italic text-xl md:text-2xl leading-none">
                    David Jiménez
                  </span>
              ...
              {/* SELLO DE IDENTIDAD */}
              <div
                className="flex items-center justify-center md:justify-start md:border-l md:pl-16"
                style={{ borderColor: subtleBorder }}
              >
