...
// AQUÍ EL ÚNICO CAMBIO: IMPORTAMOS LOS DATOS
import { referentesData } from "../data/referentes";
...
const FasePreproduccion = ({ isDark, currentTextColor }) => {
  ...
  // El array "referentesData" ya no está aquí dentro, se usa el importado arriba.
